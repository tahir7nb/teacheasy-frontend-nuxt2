    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">E-mail Family
                </h3>
                <p class="text-center mb-2 mx-2">Generate a professional e-mail communication to families and translate into multiple languages.
                </p>
                ...
                <div class="row justify-content-center m-0">
                    ...
                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0">Content to include in letter to family:</h5>
                        <div class="form-group">
                            <textarea class="form-control" rows="8" maxlength="8000" placeholder="Include specific details to include in your message to the family."
