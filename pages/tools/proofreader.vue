    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Text Proofreader
                </h3>
                <p class="text-center mb-2 mx-2">Proofread any text, fixing the grammar, spelling, and punctuation, as well as improving the clarity.
                </p>
                ...
                <div class="row justify-content-center m-0">                    
                    <div class="col-md-12 px-2 mb-4 mt-3">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="8" maxlength="8000" placeholder="the original text you want to proofread"
