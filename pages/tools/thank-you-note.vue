    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Thank You Note

                </h3>
                <p class="text-center mb-2">Generate a customized thank you note to show your appreciation!

                </p>

                <div class="row justify-content-center m-0">
                    <div class="col-md-12 px-2 mb-4 mt-3">
                        <h5 class="display-7 mb-0 mt-3">Describe what you're thanking the recipient for:</h5>
                        <div class="form-group mb-4">
                            <textarea class="form-control" rows="5" maxlength="8000"
                                placeholder="Being an enthusiastic participant in class, helping other students with work when done, staying after to clean up, bringing a positive attitude, etc."
