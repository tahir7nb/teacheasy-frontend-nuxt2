    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Professional Email Communication
                </h3>
                <p class="text-center mb-2 mx-2">Compose a formal email to your colleagues, other professionals or student’s family
                </p>

                <div class="row justify-content-center m-0">
                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0 mt-3">Recipient type:</h5>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Student parents My colleague">
                        </div>
                    </div>

                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0 mt-3">Sender name:</h5>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Ashish Gupta">
                        </div>
                    </div>

                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0">Email Content to Include:</h5>
                        <div class="form-group">
                            <textarea class="form-control" rows="8" maxlength="8000" placeholder="Paste the key points or partially written email"
