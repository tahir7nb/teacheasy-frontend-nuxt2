    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">E-mail Responder
                </h3>
                <p class="text-center mb-2 mx-2">Generate a customized professional e-mail communication in response to an email that you received.
                </p>

                <div class="row justify-content-center m-0">
                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0 mt-3">Author Name:</h5>
                    ...
                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0">Email you're responding to:</h5>
                        <div class="form-group">
                            <textarea class="form-control" rows="5" maxlength="8000" placeholder="Paste the email you’re responding to here"
                                style="white-space: pre-line; font-size: 15px;"></textarea>
                        </div>                        
                    </div>

                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0">What you want to communicate in response:</h5>
                        <div class="form-group">
                            <textarea class="form-control" rows="4" maxlength="8000" placeholder="i.e. that sounds great… let’s schedule some time… help me understand…"
                                style="white-space: pre-line; font-size: 15px;"></textarea>
                        </div>
