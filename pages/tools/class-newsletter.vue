    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Class Newsletter
                </h3>
                <p class="text-center mb-2 mx-2">Generate a newsletter to send to families weekly.
                </p>

                <div class="row justify-content-center m-0">

                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0">Important Announcements:</h5>
                        <div class="form-group">
                            <textarea class="form-control" rows="5" maxlength="8000" placeholder="Some important announcements you'd like to share."
                                style="white-space: pre-line; font-size: 15px;"></textarea>
                        </div>                        
                    </div>

                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0">Celebrations from the week:</h5>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="What were the highlights of the week?">
                        </div>
                    </div>

                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0 mt-3">Additional Content (Optional):</h5>
                        <div class="form-group">
