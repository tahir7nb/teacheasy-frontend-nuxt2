    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Text Rewriter</h3>
                <p class="text-center mb-2">Take any text and rewrite it with custom criteria however you’d like!
                </p>

                <div class="row justify-content-center m-0">
                    <div class="col-md-12 px-2 mb-0">
                        <h5 class="display-7 mb-0 mt-3">Original Text:                            
                        </h5>
                        <div class="form-group mb-4">
                            <textarea class="form-control" rows="8" maxlength="8000" placeholder="The original text you want to get rewritten" 
                            style="white-space: pre-line; font-size: 15px;"></textarea>
                        </div>                        
                    </div>
                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0 mt-0">Specific Criteria:</h5>
                        <div class="form-group mb-4">
                            <textarea class="form-control" rows="5" maxlength="8000" placeholder="Summarize key points,

Using different wording,

Reducing length by half,

Incorporating the specified information,

Format this as an instruction to students, etc"
                             style="white-space: pre-line; font-size: 15px;"></textarea>
                        </div>                        
