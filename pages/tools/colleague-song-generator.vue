    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Song Generator
                </h3>
                <p class="text-center mb-2 mx-2">Create an original song on any topic to the tune of your favourite song!
                </p>

                <div class="row justify-content-center m-0">
                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0 mt-3">Song Topic:</h5>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="A maths teacher named Mr. Ashish (ex: your or your colleagues name)">
                        </div>
                    </div>

            
                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0">Points to Incorporate in the Song:</h5>
                        <div class="form-group">
                            <textarea class="form-control" rows="8" maxlength="8000" placeholder="He coaches the maths team, earned best beard of the month, and adores the sitcom Friends.”"
                    ...
                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0 mt-3">Artist and Song Title:</h5>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Michael Jackson - Billie Jean">
                        </div>
