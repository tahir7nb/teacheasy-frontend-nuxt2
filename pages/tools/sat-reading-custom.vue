    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">SAT Reading Questions Custom

                </h3>
                <p class="text-center mb-2">Generate practice questions in the style of the SAT reading section based on any text of your choice.
                </p>
                ...
                <div class="row justify-content-center m-0">
                    ...
                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0 mt-3">Text:</h5>
...
export default {
    head() {
        return {
            title: "SAT Reading Questions Custom",
            meta: [
                {
                    hid: "description",
                    name: "description",
