    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Letter of Recommendation
                </h3>
                <p class="text-center mb-2 mx-2">Generate a letter of recommendation for a student using specific details about them.
                </p>

                <div class="row justify-content-center m-0">                 
                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0 mt-3">Relationship to Student:</h5>
                    ...
                    <div class="col-md-12 px-2">
                        <h5 class="display-7 mb-0 mt-3">Institution:</h5>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Metro State University">
                        </div>
                    </div>

                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0">Important information in include:</h5>
                        <div class="form-group">
                            <textarea class="form-control" rows="5" maxlength="8000" placeholder="List details about the student like why you are recommending this student."
