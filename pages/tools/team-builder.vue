    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Team Builder / Ice Breaker
                </h3>
                <p class="text-center mb-2 mx-2">Create a team builder / Ice Breaker for virtual or in-person meetings.
                </p>

                <div class="row justify-content-center m-0">
                    <div class="col-md-12 px-2 mt-3">
                        <h5 class="display-7 mb-0">Setting</h5>
                        <div class="form-group">
                            <select class="form-control">
                                <option value="grade1">In person</option>
                                <option value="grade1">Virtual</option>                                
                            </select>
                        </div>                       
                    </div>
                    ...
                    <div class="col-md-12 px-2 mt-0">
                        ...
                        <div class="form-group">
                            <select class="form-control">
                                <option value="grade1">No Materials</option>
                                <option value="grade1">Have materials to use</option>                                
                            </select>
                        </div>                       
                    </div>

                    <div class="col-md-12 px-2 mt-0">
                        <h5 class="display-7 mb-0">Number of Participants:</h5>
                        <div class="form-group">
                    ...
                    <div class="col-md-12 px-2 mb-4">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="5" maxlength="8000" placeholder=" End of school year, final staff meeting, team kickoff" style="white-space: pre-line; font-size: 15px;"></textarea>
                        </div>
...
export default {
    head() {
        return {
            title: "Team Builder / Ice Breaker",
            meta: [
                {
                    hid: "description",
                    name: "description",                    
