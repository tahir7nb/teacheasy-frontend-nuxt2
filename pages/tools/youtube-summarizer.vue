    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">YouTube Video Summarizer
                </h3>
                <p class="text-center mb-2 mx-2">Get a summary of a YouTube video in whatever length you choose.
                </p>
                ...
                <div class="row justify-content-center m-0">
                    <div class="col-md-12 px-2">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="1 paragraph, 1 page, 5 bullet points, 500 words">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 px-2">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="https://www.youtube.com/watch?v=8pIlOX_V25Q or 8pIlOX_V25Q">
                        </div>
