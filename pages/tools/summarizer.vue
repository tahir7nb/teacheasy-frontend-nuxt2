    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Text Summarizer
                </h3>
                <p class="text-center mb-2 mx-2">Summarise any given text to the length you desire.
                </p>

                <div class="row justify-content-center m-0">
                    <div class="col-md-12 px-2 ">
                        <h5 class="display-7 mb-0">Initial Content:</h5>
                        <div class="form-group">
                            <textarea class="form-control" rows="3" maxlength="8000" placeholder="Paste your Initial content here"
                                style="white-space: pre-line; font-size: 15px;"></textarea>
                        </div>

                    </div>
                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0 mt-3">Length of Summary:</h5>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="300 words, 3 sentences, 5 bullet points, 1 Paragraph, 1 page">
                        </div>
