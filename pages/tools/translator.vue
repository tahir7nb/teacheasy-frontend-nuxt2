    ...
    <div class="container py-3">
        <div class="row justify-content-center m-0">
            ...
            <div class="col-md-8 p-0"
                ...
                <h3 class="display-7 text-center mb-0 mt-3">Text Translator
                </h3>
                <p class="text-center mb-2 mx-2">Translate any text into another language instantly.
                </p>
                ...
                <div class="row justify-content-center m-0">
                    <div class="col-md-12 px-2 ">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="8" maxlength="8000" placeholder="the original text you want to translate"
                                style="white-space: pre-line; font-size: 15px;"></textarea>
                        </div>

                    </div>
                    <div class="col-md-12 px-2 mb-4">
                        <h5 class="display-7 mb-0 mt-3">Target Languages:</h5>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Hindi, Tamil, French, Arabic etc">
                        </div>
